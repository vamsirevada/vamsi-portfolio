  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 items-start gap-[clamp(40px,6vw,80px)] md:grid-cols-[1.1fr_0.9fr]">
        <div
          data-reveal="true"
          className="translate-y-[30px] opacity-0 transition-[opacity,transform] duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)]"
        >
          ...
          <div className="flex flex-wrap gap-2.5">
            {techStack.map((t) => (
              <span
                ...
                className="rounded-full border border-white/8 bg-card px-4 py-[9px] text-[13px] text-[#d4d4d4] transition-[transform,border-color,color] duration-250 ease-out hover:-translate-y-[3px] hover:border-accent/50 hover:text-accent"
              >
                {t}
              </span>
            ))}
        ...
        <div
          data-reveal="true"
          className="flex translate-y-[30px] flex-col gap-5 opacity-0 transition-[opacity,transform] duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)] [transition-delay:0.15s]"
        >
          <div
            data-tilt="true"
            className="relative overflow-hidden rounded-[24px] border border-white/8 transition-transform duration-200 ease-out"
